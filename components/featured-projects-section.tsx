  ...
  return (
    <Section
      ...
      background={
        <>
          {/* centered vignette */}
          <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 h-[65vh] bg-[radial-gradient(60%_50%_at_50%_50%,rgba(88,28,135,.25),transparent_70%)]" />
          {/* side glows */}
          <div className="absolute left-[-12%] top-[20%] w-[42vw] h-[42vw] rounded-full blur-3xl opacity-25 bg-gradient-to-tr from-purple-500/45 via-fuchsia-500/40 to-pink-500/30" />
