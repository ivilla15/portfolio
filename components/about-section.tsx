...
export function AboutSection() {
  return (
    <Section
      ...
      contentClassName="px-4 py-24 md:py-28" // padding lives here
      background={
        <>
          {/* centered vignette */}
          <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 h-[60vh] bg-[radial-gradient(60%_50%_at_50%_50%,rgba(88,28,135,.35),transparent_70%)]" />

          {/* side glows */}
          <div className="absolute left-[-10%] top-[25%] w-[45vw] h-[45vw] rounded-full blur-3xl opacity-25 bg-gradient-to-tr from-indigo-500/50 via-purple-500/45 to-fuchsia-500/40" />
          <div className="absolute right-[-12%] top-[10%] w-[50vw] h-[50vw] rounded-full blur-3xl opacity-20 bg-gradient-to-br from-cyan-400/45 via-sky-500/35 to-emerald-400/35" />
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(780px 460px at 50% 40%, rgba(147,51,234,.22), transparent 65%), radial-gradient(680px 420px at 18% 22%, rgba(99,102,241,.16), transparent 60%), radial-gradient(620px 420px at 82% 18%, rgba(168,85,247,.14), transparent 60%)",
            }}
          />
        </>
      }
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <Stagger step={100}>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            {/* Left column — three cards (staggered automatically) */}
              ...
              <Stagger step={120}>
                <Card className="creative-card border-0 bg-gradient-to-br from-background to-muted/20 hover:-translate-y-0.5 hover:shadow-lg">
                  <CardContent className="p-8">
                    ...
                    <p className="text-slate-300/90 leading-relaxed">
                      I&apos;m a Computer Science major at Cal State LA and a
                      Junior Web Developer Associate for the University–Student
                      Union. I build accessible, responsive websites using
                      React, TypeScript, and styled-components—focused on
                      performance, usability, and scalability. My stack includes
                      Next.js, Tailwind CSS, and shadcn/ui, and I specialize in
                      reusable components, better a11y, and solving real
                      frontend challenges.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="creative-card border-0 bg-gradient-to-br from-background to-muted/20 hover:-translate-y-0.5 hover:shadow-lg">
                  <CardContent className="p-8">
                    ...
                    <p className="text-slate-300/90 leading-relaxed">
                      I don&apos;t just ship features—I solve problems that
                      matter. Whether I&apos;m debugging critical layout issues
                      or designing inclusive components with custom responsive
                      styling, I thrive in constraints and deliver maintainable,
                      scalable solutions that users can trust.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="creative-card border-0 bg-gradient-to-br from-background to-muted/20 hover:-translate-y-0.5 hover:shadow-lg">
                  <CardContent className="p-8">
                    ...
                    <p className="text-slate-300/90 leading-relaxed">
                      ...
                      docs, and helping others grow. I explore how AI tools like
                      V0 and Copilot can enhance—never replace—creative
                      development. I&apos;m currently prepping for AWS certs,
                      building full-stack apps, and documenting it all with
                      purpose.
                    </p>
                  </CardContent>
                </Card>
